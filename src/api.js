...
export const api = {
  ...
  cubeChoicePreview: (itemId) => request('/game/equipment/cube-choice-preview', { method: 'POST', body: JSON.stringify({ itemId }) }),
  cubeChoiceApply: (itemId) => request('/game/equipment/cube-choice-apply', { method: 'POST', body: JSON.stringify({ itemId }) }),
  cubeChoiceCancel: (itemId) => request('/game/equipment/cube-choice-cancel', { method: 'POST', body: JSON.stringify({ itemId }) }),
